    ...
    public function jsonSerializeDataProvider(): array
    {
        ...
        return [
            'GET req, no req headers, no req body' => [
                'request' => new LoggableRequest(new Request('GET', 'http://example.com/request_one')),
            ...
            'GET req, no req headers, no req body, 404 response' => [
                'request' => new LoggableRequest(new Request('GET', 'http://example.com/request_two')),
                'expectedSerializedData' => [
                    'method' => 'GET',
            ...
            'POST req, no req headers, no req body, 200 response' => [
                'request' => new LoggableRequest(new Request('POST', 'http://example.com/request_three')),
                'expectedSerializedData' => [
                    'method' => 'POST',
            ...
            'GET req, w/ req headers, w/ req body' => [
                'request' => new LoggableRequest(new Request(
                    'GET',
